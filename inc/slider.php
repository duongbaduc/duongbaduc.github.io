			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						...
						<div class="button"><span><a href="details.php?proid=<?php echo $resultdell['productId']?>">Mua Hàng</a></span></div>
				   </div>
			   </div>
			   <?php 
				...
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						  ...
						  <div class="button"><span><a href="details.php?proid=<?php echo $resultSS['productId']?>">Mua Hàng</a></span></div>
					</div>
				</div>
				  <?php 
			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
				    ...
				    <div class="text list_2_of_1">
						...
						<div class="button"><span><a href="details.php?proid=<?php echo $resultAP['productId']?>">Mua Hàng</a></span></div>
				   </div>
			   </div>	
			   		 <?php 
				...
				<div class="listview_1_of_2 images_1_of_2">
					...
					<div class="text list_2_of_1">
						  ...
						  <div class="button"><span><a href="details.php?proid=<?php echo $resultOP['productId']?>">Mua Hàng</a></span></div>
					</div>
				</div>
				 <?php 
