    	...
    	<div class="content_top">
	      ...
	      <div class="section group">
				...
				<div class="grid_1_of_4 images_1_of_4">
				     ...
				     <div class="button">
				     	<span>
				     		<a  onclick="return confirm('Bạn muon mua hang nay ko ?')" href="details.php?proid=<?php echo $result['productId']?>" class="details">Mua Hàng
				     		</a>
				     	</span>
				     </div>
				     <?php 
			...
			<div class="section group">
				...
				<div class="grid_1_of_4 images_1_of_4">
				     ...
				     <div class="button"><span><a href="details.php?proid=<?php echo $result_new['productId']?>" class="details">Mua Hàng</a></span></div>
				</div>
				<?php 
						}
	      			}
